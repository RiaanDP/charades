...
2. Bundled Content
 - 5-10 pre-made categories (Movies, TV Shows, Actions, etc.)
...
## Features to Build
The app will be built incrementally. Features will be added one at a time, incrementally as guided by the developer.
